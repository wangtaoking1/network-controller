...
import (
    ...
    samplecrdv1 "github.com/wangtaoking1/network-controller/pkg/apis/samplecrd/v1"
    clientset "github.com/wangtaoking1/network-controller/pkg/client/clientset/versioned"
    networkscheme "github.com/wangtaoking1/network-controller/pkg/client/clientset/versioned/scheme"
    informers "github.com/wangtaoking1/network-controller/pkg/client/informers/externalversions/samplecrd/v1"
...
func NewController(
    ...
    networkInformer.Informer().AddEventHandler(cache.ResourceEventHandlerFuncs{
        ...
        UpdateFunc: func(old, new interface{}) {
            oldObj := old.(*samplecrdv1.Network)
            newObj := new.(*samplecrdv1.Network)
...
func (c *Controller) Run(threadiness int, stopCh <-chan struct{}) error {
    ...
    // Launch workers to process Network resources
